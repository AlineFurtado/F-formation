...
def Create_clusters():  # criação manual de uma cena
    ...
    p23, p24, p25, p26, p27, xc, yc, rc = F_formation.Circular(
        xc10, yc10, rc10)
    samples10 = F_formation.approach_samples_five(
        p23, p24, p25, p26, p27, xc10, yc10, rc10)
    ################################################################
...
### testando a plotagem de outra forma
def Plot_nods(vertex_list,central_coords_cluster_list, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27):
...
def main():
    ...
    Plot_nods(vertex_list,central_coords_cluster_list,p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27)