...
def Plot_nods(vertex_list, central_coords_cluster_list, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, p32, p33):
...
def plot_tour(tour_nodes_id, vertex_list, central_coords_cluster_list, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, p32, p33):
    ...
    # desenha as linhas entre cada par de pontos
    dx = []
    dy = []
    result = []
    for id in tour_nodes_id:
        result = vertex_list[id]
        dx.append(result[1])
        dy.append(result[2])
    ax.plot(dx, dy)
...
def main():
    ...
    tour_nodes_id = [0,12,54,44,28,23,18,41,5,32,25,34,64,0] # tMax:200

    plot_tour(tour_nodes_id, vertex_list, central_coords_cluster_list, p1, p2, p3, p4, p5, p6, p7, p8,
              p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29, p30,p31,p32,p33)
