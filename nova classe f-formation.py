# -*- coding: utf-8 -*-
"""
Created on Thu Aug 24 13:05:22 2023
...
def main():
    ...
    group1 = f_formation.Circular(xc=3, yc=2, rc=1.5)
    group2 = f_formation.Face_to_face(x1=5, y1=9.8, th1=np.deg2rad(90), x2=5, y2=12, th2=np.deg2rad(270))
    ...
    combined_samples = f_formation.get_combined_samples(group_info)
    ...
    f_formation.draw_formation(ax, people_group1, xc_group1, yc_group1, group1[3], combined_samples[:len(people_group1)], color='blue')
    f_formation.draw_formation(ax, people_group2, xc_group2, yc_group2, group2[3], combined_samples[len(people_group1):], color='green')
